...
| `formats.jpg` | Cartes verticales de la page d'accueil, une photo large découpée en trois | 2400 x 1200 px |
...
image, largeur maximale 1920 px). Les fichiers `formats.jpg` et `maroc-*.jpg` sont encore des visuels d'attente aux
